...
const FormularioAcreditado = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("http://localhost:8001/formulario", data) //cambiar para que sea un update
      .then((response) => {
    ...
    <div className="formulario-container">
      <div className="formulario">
        {acreditados.map((user, index) => (
          <form class="row g-3" onSubmit={handleSubmit(onSubmit)} key={index}>
            ...
            <div class="form-floating  col-md-4">
              <input
                ...
                required
                pattern="[a-zA-Z0-9\s]+"
                defaultValue={user.Tipo_Domicilio}
              ></input>
              <label for="floatingInput" class="asterisk">
                Tipo Domicilio
              </label>
            ...
            <div class="col-md-4">
              <select
                ...
                required
              >
                <option selected value={user.Municipio}>
                  {user.Municipio}
                </option>
            ...
            <div class="form-floating col-md-4">
              <input
                ...
                maxLength={10}
                required
                defaultValue={user.Telefono_WhatsApp}
              ></input>
            ...
            <div class="form-floating col-md-4">
              <input
                ...
                required
                defaultValue={user.No_Empleados}
              ></input>
            ...
            <div class="col-md-6">
              <input
                ...
                id="fecha"
                required
                defaultValue={user.Fecha_Inicio_Operaciones}
              ></input>
            ...
            <div class="form-floating col-md-6">
              <input
                ...
                maxLength={18}
                required
                defaultValue={user.Clabe_Interbancaria}
              ></input>
            ...
            <div class="form-floating col-md-6">
              <input
                ...
                maxLength={10}
                required
                defaultValue={user.Numero_de_Cuenta}
              ></input>
